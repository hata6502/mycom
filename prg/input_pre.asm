 ...
 add *3;
 read main; write 0;
title_str: "BlueHood Computer  Ò²Û ¾²¾² ÌßÛ¸Þ×Ñ";
wall_str: "Û";
main:
 read poweron_wait; write *2; read 65536; write *2; read sleep; write 0; poweron_wait:;
...
print_rr_2: add *3;
        ...
        print_rr_3: add *3;
                ...
                add 1;
                write 255;
  read return_6; write *2; read 4096; write *2; read sleep; write 0; return_6:;
